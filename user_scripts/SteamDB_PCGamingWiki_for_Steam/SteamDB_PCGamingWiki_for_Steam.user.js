...
(function() {
    ...
    function initScript() {
        ...
        if (!container) {
            ...
            const gameNameForHltb = pageTitleEl ? pageTitleEl.innerText.trim() : '';
            const hltbUrl = gameNameForHltb
                ? `https://howlongtobeat.com/?q=${encodeURIComponent(gameNameForHltb)}`
                : `https://howlongtobeat.com/?q=`;

            container.prepend(createNormalBtn('HowLongToBeat', hltbUrl));
